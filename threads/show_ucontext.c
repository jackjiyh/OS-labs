...
main(int argc, char **argv)
{
	...
	printf("memory address of the variable setcontext_called = %p\n",
	       (void *)(mycontext.uc_mcontext.gregs[REG_RBP]-0x8));
	printf("memory address of the variable err = %p\n",
	       (void *)(mycontext.uc_mcontext.gregs[REG_RBP]-0X4));
	...
	printf("number of bytes between err and the saved stack in mycontext "
	       "= %ld\n", (unsigned long)((mycontext.uc_mcontext.gregs[REG_RBP]-0X4) - mycontext.uc_mcontext.gregs[REG_RSP]));
